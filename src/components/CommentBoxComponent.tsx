        ...
        <Card display={'flex'} w={'50rem'} h={'auto'} radius="lg" p="md">
            ...
            <Flex direction="column" p="md" gap={'lg'}>
                ...
                <Grid align={"center"} gutter={'sm'}>
                    <Grid.Col span={1}><Image width={'2rem'} src={avatar} alt="Amy Robson" />
                    </Grid.Col>
                    ...
                    <Grid.Col span={'content'}>
                        <Text weight={'bold'} color='siteNeutral.0' >
                            ...
                            {
                                user ?
                                    <Text ml={"0.2rem"} p="3px" span bg={'sitePrimary.0'} color='white' align='center' sx={{ borderRadius: '2px' }}>you</Text>
                                    : null
                            }
                        </Text>
                    ...
                    <Grid.Col span={3}>
                        <Text color='siteNeutral.1'>One month ago</Text>
                    </Grid.Col>

                    
                        {
                            user ?
                            <Grid.Col display={'flex'} span={5} sx={{ justifyContent: "flex-end" }}>
                                <Button.Group>
                                    <Button styles={(theme) => ({
                                        root: {
                                ...
                                :
                                <Grid.Col display={'flex'} span={'auto'} offset={2} sx={{ justifyContent: "flex-end" }}>
                                <Button styles={(theme) => ({
                                    root: {
                                        backgroundColor: 'transparent',
                                        color: theme.colors.sitePrimary[0],
